...
export async function GET() {
    ...
    return new Response(JSON.stringify(lihatData), { status: 200 });
}
...
export async function POST(request) {
    ...
    const preorder = await prisma.preorder.create({
        data: { order_date: cekOrderDate, order_by, selected_package, qty: parseInt(qty), is_paid },
    });
